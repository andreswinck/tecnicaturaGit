...
public class Preguntas {
    ...
    public Preguntas(String respuesta, String rpta, int num_pregunta, double puntaje) {
    ...
    public void cargarPreguntas() { //Llenado manual de las preguntas
    ...
    public double validarRespuesta(String respuesta) {
        ...
        Preguntas puntuacion = new Preguntas();
        if (respuesta.equals(rpta)) { //Si la respuesta del usuario es correcta
            ...
            puntuacion.setPuntaje(puntaje -= 10); //resta 10 al puntaje
    ...
    public double calcularGanador() {
        ...
        Titulos creditos = new Titulos();
        if (puntaje >= 70) { //Si el puntaje final es mayor a 70, el jugador gana
            System.out.println("You win");
            System.out.println("Tu puntaje es: " + puntaje);
            ganaste.youWin();
            creditos.credits();
        } else { //Si es menor, pierde
