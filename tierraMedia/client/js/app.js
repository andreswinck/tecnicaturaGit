...
// Agregar un manejador de eventos para manejar los clics en los elementos de la lista
...
// Ejemplo de cómo incrustar secciones en el contenido (puedes personalizar esto según tus necesidades)
const seccionInicio = document.createElement('section');
seccionInicio.id = 'inicio';
seccionInicio.textContent = 'Contenido de la sección de Inicio.';
contenido.appendChild(seccionInicio);

const seccionAcerca = document.createElement('section');
seccionAcerca.id = 'acerca';
seccionAcerca.textContent = 'Contenido de la sección Acerca de.';
contenido.appendChild(seccionAcerca);

const seccionServicios = document.createElement('section');
seccionServicios.id = 'servicios';
seccionServicios.textContent = 'Contenido de la sección de Servicios.';
contenido.appendChild(seccionServicios);

const seccionContacto = document.createElement('section');
seccionContacto.id = 'contacto';
seccionContacto.textContent = 'Contenido de la sección de Contacto.';
contenido.appendChild(seccionContacto);
